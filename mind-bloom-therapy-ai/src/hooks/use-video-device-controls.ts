...
// Controls for toggling video, audio, and screen sharing with improved error handling
export const useVideoDeviceControls = (
  ...
  // Toggle screen sharing with proper track replacement and error handling
