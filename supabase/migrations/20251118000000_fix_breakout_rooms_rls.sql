-- Migration: Fix Breakout Rooms RLS Policy for Therapists
-- Created: 2025-11-18
-- Description: Simplify therapist RLS policy to allow therapists to view rooms in their sessions
...
-- Also ensure the SELECT policy allows therapists to view
-- (The above FOR ALL policy should cover this, but let's be explicit)
-- The existing "Users can view breakout rooms in their sessions" policy already covers participants
-- So therapists should be able to view via the FOR ALL policy above
