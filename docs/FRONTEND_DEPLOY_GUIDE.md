...
# ? What's your project's name? mind-boom-3-0-twilio
...
2. Select your project: `mind-boom-3-0-twilio`
...
# Enter: https://mind-boom-3-0-twilio.vercel.app
# Select: Preview, Development
...
# https://mind-boom-3-0-twilio.vercel.app
```
...
1. Go to: https://vercel.com/dashboard
2. Select project: `mind-boom-3-0-twilio`
3. Go to: **Settings → Git**
4. Connect repository: `Samdekian/MindBoom-3.0-Twilio`
5. Configure:
...
# ? Team: [Your team]
# ? Site name: mind-boom-3-0-twilio
...
netlify env:set VITE_APP_URL "https://mind-boom-3-0-twilio.netlify.app"
```
...
docker build \
  ...
  -t mind-boom-3-0-twilio:staging \
  .
```
...
STAGING_URL="https://mind-boom-3-0-twilio.vercel.app"
...
Open in browser: `https://mind-boom-3-0-twilio.vercel.app`
...
3. Add:
   - **Site URL**: `https://mind-boom-3-0-twilio.vercel.app`
   - **Redirect URLs**: `https://mind-boom-3-0-twilio.vercel.app/**`
...
# Run previous image
docker run -d --name mindboom-staging mind-boom-3-0-twilio:previous-tag
```
