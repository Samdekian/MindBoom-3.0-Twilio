...
import { EnhancedDeviceManager } from './preparation/EnhancedDeviceManager';
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <CardContent className="space-y-6">
        ...
        <EnhancedDeviceManager 
          permissionsGranted={coordinator.permissionHandler.permissionState.bothGranted}
          onDeviceTest={async (deviceType) => {
            // Device testing is now handled by the coordinator
          ...
          onDeviceChange={(device, deviceId) => {
            console.log('Device changed:', device, deviceId);
            // Device changes will be handled by the coordinator's stream manager
          }}
        />
      </CardContent>
